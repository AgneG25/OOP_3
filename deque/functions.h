...
void Read (int N, deque<stud> &Students, int &longestName, int &longestSurname, int nr);
void Read_from_file(deque<stud> &Students, int &longestName, int &longestSurname, string filename);
void Write (deque<stud> &Students, int &longestName, int &longestSurname);
bool Compare_By_firstName(const stud &a, const stud &b);
void Sort_By_firstName(deque<stud> &Students);
void New_Students (deque<stud> &Students, int &longestName, int &longestSurname, deque<stud> &Weak);
void PrintByMarks (int n, deque<stud> &Students, deque<stud> &Weak);
void SortByMarks(deque<stud> &Students, deque<stud> &Weak);
